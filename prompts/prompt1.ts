...
This is part of the minified javascript file. It was cut to have 500 symbols before and after the "Line number" and "Column number" in the stack trace: {code}
