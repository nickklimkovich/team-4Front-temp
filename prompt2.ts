...
Based on the code snippet and any available clues (like function or variable names), attempt to identify the corresponding file and function in the original, unminified source code.
